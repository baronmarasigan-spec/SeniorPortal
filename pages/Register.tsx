...
export const Register: React.FC = () => {
  ...
  const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files) {
      // Added explicit File type to map function to fix 'Property name does not exist on type unknown' error
  ...
  const handleSubmit = () => {
    // In a real app, we'd create the user and the application
    // For this demo, we submit a registration application
    addApplication({
